...
@Command(name = "add", aliases = {"a"}, description = "Adds a new item to the project. Alias: 'a'. This command allows adding dependencies, pipelines, profiles, and Dockerfiles.",
